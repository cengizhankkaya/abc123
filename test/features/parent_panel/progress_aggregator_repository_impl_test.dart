...
void main() {
  group('ProgressAggregatorRepositoryImpl & RecommendationRepositoryImpl Testleri', () {
    test('Tüm kaynaklardan veriyi doğru toplar ve genel doğruluk hesaplar', () {
      ...
      final service = ProgressAggregatorRepositoryImpl([s1, s2]);
    ...
    test('RecommendationRepositoryImpl zorlanılan öğeler veya düşük doğruluk için akıllı öneri üretir', () {
      ...
      final recs = RecommendationRepositoryImpl().generateRecommendations(
        progressList: [p1],
        isTurkish: true,
      );
