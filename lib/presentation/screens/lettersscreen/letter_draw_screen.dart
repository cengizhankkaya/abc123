...
class _LetterDrawScreenState extends State<LetterDrawScreen>
  ...
  // Sonuç ekranı gösterme fonksiyonu (sadece UI)
  void _showResultScreen(bool isCorrect, DrawingProvider drawingProvider) {
    try {
      if (isCorrect) {
                ...
                onRecognize: () async {
                  if (!drawingProvider.showResult &&
                    ...
                    if (drawingProvider
                      ...
                      _showResultScreen(isCorrect, drawingProvider);
                    } else {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
