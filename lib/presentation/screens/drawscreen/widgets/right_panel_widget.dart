  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(
        right: responsive.sidePadding,
        top: responsive.height * 0.01,
        bottom: responsive.height * 0.01,
      ),
      // Panel genişliğini azaltalım
      width: responsive.width * 0.32, // 0.35'ten 0.32'ye düşürüldü
      height: responsive.height * 0.98,
      child: Column(
        children: [
          Expanded(
            child: Container(
                ...
                children: [
                  ...
                  if (_isGameStarted)
                    Container(
                      ...
                      padding: EdgeInsets.symmetric(
                        horizontal:
                            responsive.width * 0.003, // Daha az yatay dolgu
                        vertical:
                            responsive.height * 0.003, // Daha az dikey dolgu
                      ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          _buildGameStatusIcon(
                            ...
                            color: Colors.blue,
                            value: "$_remainingBalloons/$_totalBalloons",
