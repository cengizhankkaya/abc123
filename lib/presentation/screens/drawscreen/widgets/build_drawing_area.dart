...
Widget buildDrawingArea(
  ...
  final double drawingSize = size.height * 0.6 > 280 ? size.height * 0.6 : 280;
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            borderRadius: BorderRadius.circular(drawingSize * 0.05),
          ),
          child: ClipRRect(
            borderRadius: BorderRadius.circular(drawingSize * 0.05),
                  ...
                  DrawingPoint(
                    ...
                    paint: Paint()
                      ...
                      ..strokeWidth = strokeWidth *
                          (drawingSize / 280) // Boyutu ekrana göre ölçeklendir
                      ..isAntiAlias = true,
                  ),
                );
              },
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: drawingSize * 0.08,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                      SizedBox(height: drawingSize * 0.07),
                      Container(
                        width: drawingSize * 0.35,
                        height: drawingSize * 0.35,
                        decoration: BoxDecoration(
                          color: AppColors.accentColor,
