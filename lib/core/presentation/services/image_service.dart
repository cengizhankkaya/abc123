...
/// Flutter `Widget` döndürdüğü için domain portuna çıkarılamayan
/// uygulama içi görsel yöneticisi.
///
/// Önceki konum: `core/infrastructure/images/image_manager.dart`
/// Yeni konum   : `core/presentation/services/image_service.dart`
///
...
/// Geriye dönük uyumluluk için [ImageManager] type alias.
/// Yeni kod [ImageService] kullanmalıdır.
@Deprecated('Use ImageService instead')
typedef ImageManager = ImageService;
