...
import '../../features/colors/application/usecases/get_color_palettes.dart' as _i920;
import '../../features/colors/domain/repositories/i_color_game_repository.dart' as _i1025;
import '../../features/colors/infrastructure/repositories/color_game_repository_impl.dart' as _i601;
import '../../features/colors/presentation/failure_message/color_failure_message_mapper.dart'
    as _i744;
import '../../features/draw/application/usecases/recognize_letter.dart' as _i222;
import '../../features/draw/application/usecases/recognize_number.dart' as _i409;
import '../../features/draw/domain/repositories/i_number_recognition_repository.dart' as _i826;
import '../../features/draw/domain/repositories/i_recognition_repository.dart' as _i330;
...
import '../../features/draw/infrastructure/repositories/number_recognition_repository_impl.dart'
    as _i502;
import '../../features/draw/presentation/failure_message/draw_failure_message_mapper.dart' as _i510;
import '../../features/draw/presentation/providers/draw_screen_provider.dart' as _i879;
import '../../features/home/application/quest/quest_rollover_resolver.dart' as _i1018;
import '../../features/home/application/usecases/load_gamification_initial_state.dart' as _i522;
import '../../features/home/application/usecases/persist_drawing_counters.dart' as _i188;
import '../../features/home/application/usecases/persist_quest_ledger.dart' as _i110;
import '../../features/home/domain/repositories/i_gamification_persistence.dart' as _i725;
import '../../features/home/infrastructure/datasources/gamification_local_data_source.dart'
    as _i977;
import '../../features/home/infrastructure/mappers/gamification_failure_mapper.dart' as _i605;
import '../../features/home/infrastructure/repositories/gamification_repository_impl.dart' as _i603;
import '../../features/home/presentation/failure_message/home_failure_message_mapper.dart' as _i24;
import '../../features/home/presentation/providers/gamification_provider.dart' as _i1019;
import '../../features/info/presentation/failure_message/info_failure_message_mapper.dart' as _i565;
import '../../features/letters/presentation/failure_message/letter_failure_message_mapper.dart'
    as _i602;
import '../../features/letters/presentation/providers/letter_drawing_provider.dart' as _i961;
import '../../features/numbers_advanced/application/usecases/recognize_multi_digit.dart' as _i558;
...
import '../../features/numbers_advanced/presentation/failure_message/math_failure_message_mapper.dart'
    as _i270;
import '../../features/numbers_advanced/presentation/providers/math_progress_provider.dart' as _i96;
import '../../features/parent_panel/application/usecases/get_recommendations.dart' as _i126;
import '../../features/parent_panel/domain/repositories/i_recommendation_repository.dart' as _i31;
...
import '../../features/parent_panel/presentation/failure_message/parent_panel_failure_message_mapper.dart'
    as _i869;
import '../../features/shapes/application/usecases/recognize_shape.dart' as _i865;
import '../../features/shapes/domain/repositories/i_shape_recognition_repository.dart' as _i787;
import '../../features/shapes/infrastructure/datasources/shape_inference_data_source.dart' as _i598;
import '../../features/shapes/infrastructure/mappers/shape_failure_mapper.dart' as _i997;
...
import '../../features/shapes/presentation/failure_message/shape_failure_message_mapper.dart'
    as _i300;
import '../../features/shapes/presentation/providers/shapes_drawing_provider.dart' as _i93;
import '../../features/words/application/usecases/get_word_list.dart' as _i645;
import '../../features/words/domain/repositories/i_word_repository.dart' as _i739;
import '../../features/words/infrastructure/repositories/word_repository_impl.dart' as _i239;
import '../../features/words/presentation/failure_message/word_failure_message_mapper.dart'
    as _i671;
import '../../features/words/presentation/providers/word_drawing_provider.dart' as _i337;
...
Future<_i174.GetIt> init(
  ...
  gh.factory<_i1018.QuestRolloverResolver>(() => _i1018.QuestRolloverResolver());
  ...
  gh.lazySingleton<_i558.FlutterSecureStorage>(() => storageModule.flutterSecureStorage());
  gh.lazySingleton<_i744.ColorFailureMessageMapper>(() => _i744.ColorFailureMessageMapper());
  gh.lazySingleton<_i510.DrawFailureMessageMapper>(() => _i510.DrawFailureMessageMapper());
  gh.lazySingleton<_i24.HomeFailureMessageMapper>(() => _i24.HomeFailureMessageMapper());
  gh.lazySingleton<_i565.InfoFailureMessageMapper>(() => _i565.InfoFailureMessageMapper());
  gh.lazySingleton<_i602.LetterFailureMessageMapper>(() => _i602.LetterFailureMessageMapper());
  gh.lazySingleton<_i270.MathFailureMessageMapper>(() => _i270.MathFailureMessageMapper());
  gh.lazySingleton<_i869.ParentPanelFailureMessageMapper>(
      () => _i869.ParentPanelFailureMessageMapper());
  gh.lazySingleton<_i300.ShapeFailureMessageMapper>(() => _i300.ShapeFailureMessageMapper());
  gh.lazySingleton<_i671.WordFailureMessageMapper>(() => _i671.WordFailureMessageMapper());
  gh.lazySingleton<_i598.IShapeInferenceDataSource>(() => _i598.ShapeInferenceDataSourceImpl());
  ...
  gh.lazySingleton<_i747.ExceptionHandler>(() => _i747.ExceptionHandlerImpl(gh<_i354.AppLogger>()));
  ...
  gh.lazySingleton<_i330.IRecognitionRepository>(() => _i857.LetterRecognitionRepositoryImpl(
        gh<_i747.ExceptionHandler>(),
        gh<_i537.FailureMapper>(),
      ));
  gh.lazySingleton<_i826.INumberRecognitionRepository>(() => _i502.NumberRecognitionRepositoryImpl(
        gh<_i747.ExceptionHandler>(),
        gh<_i537.FailureMapper>(),
      ));
  gh.lazySingleton<_i624.IFeatureFlagService>(() => _i600.FeatureFlagService());
  gh.lazySingleton<_i31.IRecommendationRepository>(() => _i389.RecommendationRepositoryImpl(
        gh<_i747.ExceptionHandler>(),
        gh<_i537.FailureMapper>(),
      ));
  ...
  gh.lazySingleton<_i725.IGamificationPersistence>(() => _i603.GamificationRepositoryImpl(
  ...
  gh.lazySingleton<_i1025.IColorGameRepository>(() => _i601.ColorGameRepositoryImpl(
        gh<_i747.ExceptionHandler>(),
        gh<_i537.FailureMapper>(),
      ));
  ...
  gh.factory<_i645.GetWordList>(() => _i645.GetWordList(gh<_i739.IWordRepository>()));
  ...
  gh.lazySingleton<_i787.IShapeRecognitionRepository>(() => _i813.ShapeRecognitionRepositoryImpl(
  ...
  gh.factoryParam<_i879.DrawScreenProvider, _i409.BuildContext?, _i721.AppLanguage?>((
    context,
    language,
  ) =>
  ...
  gh.lazySingleton<_i22.AppApiService>(() => networkModule.appApiService(gh<_i31.ChopperClient>()));
