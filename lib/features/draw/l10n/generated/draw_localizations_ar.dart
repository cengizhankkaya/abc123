...
class DrawLocalizationsAr extends DrawLocalizations {
  DrawLocalizationsAr([String locale = 'ar']) : super(locale);

  @override
  String drawNumberInstruction(String number) {
    return 'ارسم الرقم $number';
  }

  @override
  String get drawAnyNumberInstruction => 'ارسم رقماً';

  @override
  String get watchAdToUnlock => 'شاهد الإعلانات لكسب النقاط وفتح هذا القسم';

  @override
  String get drawSequentialMode => 'وضع الرسم المتسلسل:';
  ...
  @override
  String get drawClear => 'مسح';

  @override
  String get drawPen => 'قلم';

  @override
  String get drawEraser => 'ممحاة';

  @override
  String get drawRecognize => 'تعرّف';

  @override
  String get drawPenColor => 'لون القلم';

  @override
  String get drawNumberSectionTitle => 'تعلم الأرقام';

  @override
  String get drawLetterSectionTitle => 'تعلم الحروف';

  @override
  String get drawShapeSectionTitle => 'تعلم الأشكال';
