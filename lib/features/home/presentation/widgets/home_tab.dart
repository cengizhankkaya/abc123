...
class _HomeTabState extends State<HomeTab> with RewardedAdHelper<HomeTab> {
  ...
  /// Dar (telefon) → 2, Orta (tablet) → 3, Geniş (web/masaüstü) → 4.
  ...
  /// Görsel asset'i olmayan kategoriler için zengin ikon kompozisyonu.
  /// Tek düz ikon yerine arka planda büyük/soluk + ön planda küçük/belirgin ikon.
  Widget _richIcon({
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // HomeContinueCard kendi içinde hasLastActivity yoksa
                  // SizedBox.shrink döndürür; boşluk sadece aktifken göster.
