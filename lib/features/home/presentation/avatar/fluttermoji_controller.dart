    ...
    switch (attributeKey) {
      ...
      case 'eyeType':
        return '''<svg width="20px" height="20px" viewBox="-3 -30 120 120">''' +
            (eyes[EyeType[attributeValueIndex!]] as String) +
            '''</svg>''';

      case 'eyebrowType':
        return '''<svg width="20px" height="20px" viewBox="-3 -50 120 120">''' +
            (eyebrow[EyebrowType[attributeValueIndex!]] as String) +
            '''</svg>''';

      case 'mouthType':
        return '''<svg width="20px" height="20px" viewBox="0 10 120 120">''' +
            (mouth[MouthType[attributeValueIndex!]] as String) +
            '''</svg>''';

      case 'accessoriesType':
        if (attributeValueIndex == 0) return emptySVGIcon;
        return '''<svg width="20px" height="20px" viewBox="-3 -50 120 170" >''' +
            (accessories[AccessoriesType[attributeValueIndex!]] as String) +
            '''</svg>''';
...
\t\t\t\t\t\t<use fill="#D0C6AC" xlink:href="#path-5"></use>
        ''' +
            (skin[SkinColor[attributeValueIndex!]] as String) +
