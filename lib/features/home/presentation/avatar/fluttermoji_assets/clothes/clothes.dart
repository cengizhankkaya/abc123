...
class Clothes {
  ...
  static String? generateClothes(
    ...
    String? colorHex = clotheColor[clColor] as String?;
...
<g id="Clothing/Shirt-Crew-Neck" transform="translate(0.000000, 170.000000)">
      ...
      "ShirtVNeck": '''
        ...
        ''',
      "Sport-Tank-Top": '''
					<g id="Clothing/Sport-Tank-Top" transform="translate(0.000000, 170.000000)">
						<defs>
							<path d="M75,30 C75,50 100,70 132,70 C164,70 189,50 189,30 C210,35 232,65 232,101 L232,110 L32,110 L32,101 C32,65 54,35 75,30 Z" id="react-path-tanktop"></path>
						</defs>
						<mask id="react-mask-tanktop" fill="white">
							<use xlink:href="#react-path-tanktop"></use>
						</mask>
						<use id="Clothes" fill="#E6E6E6" fill-rule="evenodd" xlink:href="#react-path-tanktop"></use>
						<g id="Color" mask="url(#react-mask-tanktop)" fill-rule="evenodd" fill="$colorHex">
							<rect x="0" y="0" width="264" height="110"></rect>
						</g>
					</g>
        ''',
      "Turtleneck-Sweater": '''
					<g id="Clothing/Turtleneck-Sweater" transform="translate(0.000000, 170.000000)">
						<defs>
							<path d="M90,10 L174,10 C180,10 184,20 184,35 L184,45 C215,50 232,75 232,101 L232,110 L32,110 L32,101 C32,75 49,50 80,45 L80,35 C80,20 84,10 90,10 Z" id="react-path-turtleneck"></path>
						</defs>
						<mask id="react-mask-turtleneck" fill="white">
							<use xlink:href="#react-path-turtleneck"></use>
						</mask>
						<use id="Clothes" fill="#E6E6E6" fill-rule="evenodd" xlink:href="#react-path-turtleneck"></use>
						<g id="Color" mask="url(#react-mask-turtleneck)" fill-rule="evenodd" fill="$colorHex">
							<rect x="0" y="0" width="264" height="110"></rect>
						</g>
					</g>
        ''',
      "Hero-Suit": '''
					<g id="Clothing/Hero-Suit" transform="translate(0.000000, 170.000000)">
						<defs>
							<path d="M181.5,32.3 C210.8,41.5 232,68.8 232,101 L232,110 L32,110 L32,101 C32,68.4 53.7,40.8 83.5,32 C83.2,33.4 83,34.9 83,36.3 C83,52.6 105.2,65.8 132.5,65.8 C159.8,65.8 182,52.6 182,36.3 C182,35 181.8,33.6 181.5,32.3 Z" id="react-path-herosuit"></path>
						</defs>
						<mask id="react-mask-herosuit" fill="white">
							<use xlink:href="#react-path-herosuit"></use>
						</mask>
						<use id="Clothes" fill="#1565C0" fill-rule="evenodd" xlink:href="#react-path-herosuit"></use>
						<g id="Color" mask="url(#react-mask-herosuit)" fill-rule="evenodd" fill="$colorHex">
							<rect x="0" y="0" width="264" height="110"></rect>
						</g>
						<g id="Hero-Chest-Crest" mask="url(#react-mask-herosuit)">
							<polygon points="132,68 156,76 146,98 118,98 108,76" fill="#FFD700" stroke="#C62828" stroke-width="2.5"></polygon>
							<polygon points="132,73 149,79 141,94 123,94 115,79" fill="#D32F2F"></polygon>
							<path d="M125,86 C128,82 136,82 138,86 C140,90 126,90 128,94" stroke="#FFD700" stroke-width="3" stroke-linecap="round" fill="none"></path>
						</g>
					</g>
        ''',
      "Spider-Suit": '''
					<g id="Clothing/Spider-Suit" transform="translate(0.000000, 170.000000)">
						<defs>
							<path d="M181.5,32.3 C210.8,41.5 232,68.8 232,101 L232,110 L32,110 L32,101 C32,68.4 53.7,40.8 83.5,32 C83.2,33.4 83,34.9 83,36.3 C83,52.6 105.2,65.8 132.5,65.8 C159.8,65.8 182,52.6 182,36.3 C182,35 181.8,33.6 181.5,32.3 Z" id="react-path-spidersuit"></path>
						</defs>
						<mask id="react-mask-spidersuit" fill="white">
							<use xlink:href="#react-path-spidersuit"></use>
						</mask>
						<use id="Clothes" fill="#E53935" fill-rule="evenodd" xlink:href="#react-path-spidersuit"></use>
						<g id="Color" mask="url(#react-mask-spidersuit)" fill-rule="evenodd" fill="$colorHex">
							<rect x="0" y="0" width="264" height="110"></rect>
						</g>
						<g id="Spider-Details" mask="url(#react-mask-spidersuit)">
							<!-- Web Lines -->
							<path d="M132,65 L132,110 M100,75 L164,75 M90,90 L174,90 M80,105 L184,105" stroke="#000000" stroke-width="1.5" opacity="0.45"></path>
							<path d="M132,65 L95,110 M132,65 L169,110" stroke="#000000" stroke-width="1.5" opacity="0.45"></path>
							<!-- Spider Emblem -->
							<circle cx="132" cy="85" r="5" fill="#111111"></circle>
							<ellipse cx="132" cy="94" rx="4" ry="6" fill="#111111"></ellipse>
							<path d="M125,82 L139,90 M125,90 L139,82 M123,88 L141,96 M123,96 L141,88" stroke="#111111" stroke-width="2" stroke-linecap="round"></path>
						</g>
					</g>
        ''',
      "Dark-Knight-Armor": '''
					<g id="Clothing/Dark-Knight-Armor" transform="translate(0.000000, 170.000000)">
						<defs>
							<path d="M181.5,32.3 C210.8,41.5 232,68.8 232,101 L232,110 L32,110 L32,101 C32,68.4 53.7,40.8 83.5,32 C83.2,33.4 83,34.9 83,36.3 C83,52.6 105.2,65.8 132.5,65.8 C159.8,65.8 182,52.6 182,36.3 C182,35 181.8,33.6 181.5,32.3 Z" id="react-path-batarmor"></path>
						</defs>
						<mask id="react-mask-batarmor" fill="white">
							<use xlink:href="#react-path-batarmor"></use>
						</mask>
						<use id="Clothes" fill="#263238" fill-rule="evenodd" xlink:href="#react-path-batarmor"></use>
						<g id="Color" mask="url(#react-mask-batarmor)" fill-rule="evenodd" fill="$colorHex">
							<rect x="0" y="0" width="264" height="110"></rect>
						</g>
						<g id="Armor-Plates-And-Bat" mask="url(#react-mask-batarmor)">
							<!-- Armor Plating Lines -->
							<path d="M90,70 L115,85 L115,110 M174,70 L149,85 L149,110 M115,85 L149,85" stroke="#000000" stroke-width="3" opacity="0.6" fill="none"></path>
							<!-- Gold Bat Emblem Oval -->
							<ellipse cx="132" cy="84" rx="18" ry="10" fill="#FDD835" stroke="#000000" stroke-width="1.5"></ellipse>
							<!-- Bat Wings Silhouette -->
							<path d="M120,84 C124,80 128,83 132,81 C136,83 140,80 144,84 C141,87 138,85 136,88 L132,86 L128,88 C126,85 123,87 120,84 Z" fill="#000000"></path>
						</g>
					</g>
        ''',
    };

    return clothes[clotheType] as String?;
  }
}
