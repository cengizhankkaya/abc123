...
<g id="Mouth/Twinkle" transform="translate(2.000000, 52.000000)" fill-opacity="0.599999964" fill-rule="nonzero" fill="#000000">
  ...
  'Vomit': '''
        ...
        ''',
  'Surprised': '''
        <g id="Mouth/Surprised" transform="translate(2.000000, 52.000000)" fill="#000000" fill-opacity="0.699999988">
          <circle cx="54" cy="20" r="7" />
        </g>
        ''',
  'Laughing': '''
        <g id="Mouth/Laughing" transform="translate(2.000000, 52.000000)">
          <path d="M37,14 C39,26 45,31 54,31 C63,31 69,26 71,14 C71.1,13.2 70.2,12 69,12 C55,12 45,12 39,12 C37.8,12 36.9,13.2 37,14 Z" fill="#000000" fill-opacity="0.699999988" />
          <rect x="42" y="12" width="24" height="6" rx="3" fill="#FFFFFF" />
          <path d="M46,27 C49,24 59,24 62,27 Z" fill="#FF4F6D" />
        </g>
        ''',
  'Whistle': '''
        <g id="Mouth/Whistle" transform="translate(2.000000, 52.000000)">
          <circle cx="50" cy="18" r="5" fill="#000000" fill-opacity="0.699999988" />
          <path d="M57,15 C59,13 62,13 64,15" stroke="#000000" stroke-width="2" stroke-linecap="round" fill="none" stroke-opacity="0.5" />
        </g>
        ''',
};
