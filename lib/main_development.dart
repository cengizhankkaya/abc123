...
/// Geliştirme ortamı giriş noktası (`01_project_structure.md` — Build Flavors).
///
/// Çalıştırmak için:
/// ```sh
/// flutter run --dart-define=APP_ENV=development -t lib/main_development.dart
/// ```
void main() async {
  await bootstrap();
  assert(
    AppEnvironment.current == AppEnvironment.development,
    'main_development.dart yalnızca APP_ENV=development ile çalıştırılmalıdır.',
  );
